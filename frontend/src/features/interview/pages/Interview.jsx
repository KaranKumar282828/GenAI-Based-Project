...
const Interview = () => {
    ...
    // ✅ loading hata diya — granular states use karo
    const { report, fetchingReport, downloadingResume, getResumePdf, error } = useInterview()
    const { interviewId } = useParams()


    // ✅ Sirf report fetch hote waqt full loading screen
    if (fetchingReport) {
        return (
    ...
    if (!report) {
        return (
            <main className="loading-screen">
                <div className="error-banner">Report not found.</div>
            </main>
        )
    }
    ...
    return (
        <div className="interview-page">
            ...
            {/* ✅ Resume download hote waqt overlay */}
            {downloadingResume && (
                <div className="generating-overlay">
                    <div className="generating-overlay__box">
                        <div className="spinner-lg" />
                        <h3>Generating your resume...</h3>
                        <p>AI is crafting a tailored resume for this role</p>
                        <p className="generating-overlay__time">⏱ This may take 15-20 seconds</p>
                    </div>
                </div>
            )}
            ...
            <div className="interview-layout">
                ...
                <nav className="interview-nav">
                    ...
                    {/* ✅ downloadingResume use karo — loading nahi */}
                    <button
